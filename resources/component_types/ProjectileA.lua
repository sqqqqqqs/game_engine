ProjectileA = {
	...
	OnUpdate = function(self)
		local player = Actor.Find("PlayerB"):GetComponent("Transform")
		if player.x - self.transform.x < 10 and abs(self.transform.y - player.y) < 10 then 
